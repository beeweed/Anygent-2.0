...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-100">
      <HeaderBar iteration={iteration} maxIterations={maxIterations} ready={ready} onOpenSettings={() => setSettingsOpen(true)} />
      <main className="mx-auto grid max-w-[1800px] gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(360px,0.9fr)] lg:px-8 lg:py-8">
        <ChatPanel />
        <FileTreePanel />
      </main>
